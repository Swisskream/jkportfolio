...
<h2>☁️ Cloud Implementation</h2>

<p>This site is fully deployed and hosted using AWS cloud services:</p>
<ul>
  <li><strong>Amazon S3</strong> – Hosts the static frontend assets</li>
  <li><strong>CloudFront</strong> – Distributes content globally via CDN</li>
  <li><strong>Route 53</strong> – Manages DNS for the custom domain</li>
  <li><strong>AWS Certificate Manager</strong> – Provides HTTPS encryption</li>
</ul>

<hr />

<h2>🛠️ Recent Updates</h2>

<h3>✅ 4/22 – Hosted Portfolio on AWS</h3>
<p>
  Deployed this site to AWS using S3, CloudFront, and Route 53 to serve content through a custom domain.
</p>

<h3>✅ 4/23 – Visitor Counter Added</h3>
<p>
  Integrated a dynamic page view counter using:
</p>
<ul>
  <li><strong>DynamoDB</strong> – Stores number of visits</li>
  <li><strong>Lambda</strong> – Updates view count via backend function</li>
  <li><strong>API Gateway + React</strong> – Calls the Lambda function on each visit</li>
</ul>

<h3>✅ 4/29 – CI/CD Integration</h3>
<p>
  Set up a full CI/CD workflow:
  Code pushed to GitHub triggers a build and deploy process,
  automatically updating the static site in the S3 bucket.
</p>
...
<p>Thanks for visiting my portfolio! Feel free to explore the projects and reach out if you'd like to connect or collaborate.</p>
